...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = APBSlave_Breakout_Keyboard
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = APBSlave_Breakout_synth
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = VideoController_0
END
