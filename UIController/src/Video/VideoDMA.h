...
#define VIDEO_BREAKOUT_ADDR (XPAR_APBSLAVE_BREAKOUT_2_BASEADDR)

#define V_FRAME_PTR_OFF 0x00
#define V_FRAME_PTR_REG Reg32(VIDEO_BREAKOUT_ADDR+V_FRAME_PTR_OFF)
